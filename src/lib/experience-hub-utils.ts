...
export const TRIPTYCH_HEIGHT = "clamp(500px, 58vh, 560px)";
/** Destaque sutil — cards inativos devem caber título, descrição e preço. */
export const INACTIVE_PANEL_FLEX = 30;
export const ACTIVE_PANEL_FLEX = 40;

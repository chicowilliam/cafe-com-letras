...
export function About() {
  return (
    <section
      id="sobre"
      className="about-history section-canvas section-canvas--shift section-padding relative grid w-full grid-cols-1 items-stretch overflow-x-clip md:grid-cols-[46%_54%] lg:grid-cols-[42%_58%]"
    >

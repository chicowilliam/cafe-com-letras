              ...
              {submitted ? (
                ...
                >
                  ...
                  <input
                    ...
                    className="focus-ring min-w-0 flex-1 rounded-full border border-hairline bg-surface px-5 py-3 text-sm text-foreground placeholder:text-foreground-muted/60"
                  />
                  <button
                    type="submit"
